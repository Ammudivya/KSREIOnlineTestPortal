...
namespace Login
{
    public partial class TestReports : System.Web.UI.Page
    {
        ...
        protected void Button1_Click1(object sender, EventArgs e)
        {
            ...
            conn.Open();
            SqlCommand cmdd = new SqlCommand("select test_name,test_type,test_category,test_start_duration,conducted_by,conducted_to_college,conducted_to_department,conducted_to_year from TestDetails where (conducted_to_college=@0 and conducted_to_department=@1 and conducted_to_year=@2 )", conn);
