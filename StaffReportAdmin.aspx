<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StaffReportAdmin.aspx.cs" Inherits="Login.StaffReportAdmin" %>
...
<ul  id="right-side" class="auto-style1">            
            <li ><i class="fa fa-home" aria-hidden="true" style="font-size:23px;color:white;"></i><a href="AdminHome.aspx"> Home</a></li>
    ...
    <form id="form1" runat="server">
        <br /><br />
        <asp:Button ID="Button1" runat="server" Text="Back" OnClick="Button1_Click" class="btn btn-success"/>
        <div class="top"> 
